    ...
    <>
      ...
      <main style={{ maxWidth: "760px", margin: "0 auto", padding: "2rem 1.25rem 4rem" }}>
        <div style={{ textAlign: "center", marginBottom: "2rem" }}>
          ...
          <p style={{ fontFamily: "'Noto Sans TC','Noto Sans SC',sans-serif", fontSize: "0.9rem", color: "#8a5a2f" }}>
            最後更新：2026 年 5 月
          </p>
        </div>

        <div className="zen-card" style={{ padding: "2rem", lineHeight: 2 }}>
          <article style={{ fontFamily: "'Noto Sans TC','Noto Sans SC',sans-serif", fontSize: "1rem", color: "#2c1810" }}>

            <Section title="一、總則">
              <p>「佛說」是一個免費的佛法學習工具，致力於以 AI 技術弘揚佛法智慧。本站尊重並保護您的隱私權。</p>
            </Section>
            ...
            <Section title="二、我們不收集的資訊">
              <ul style={{ paddingLeft: "1.5rem" }}>
                ...
                <li>信用卡、銀行賬戶等支付資訊</li>
                <li>您無需註冊賬號即可使用本站所有功能</li>
              </ul>
            </Section>

            <Section title="三、本地存儲（localStorage）">
              <p>本站在您的瀏覽器本地存儲以下數據，這些數據<strong>不會上傳至任何服務器</strong>：</p>
              <ul style={{ paddingLeft: "1.5rem" }}>
                <li><strong>匿名用戶 ID</strong>：隨機生成，不含任何個人資訊</li>
                <li><strong>對話歷史</strong>：最近若干條問答記錄，僅存於本地</li>
            ...
            <Section title="六、您的權利">
              <ul style={{ paddingLeft: "1.5rem" }}>
                <li>清除瀏覽器數據以刪除所有本地存儲內容</li>
                <li>啟用瀏覽器「Do Not Track」以停用匿名統計</li>
              </ul>
            </Section>

            <Section title="七、聯繫方式">
        ...
        <div style={{ textAlign: "center", marginTop: "2rem" }}>
          <p style={{ fontFamily: "'Noto Serif TC','Noto Serif SC',serif", fontSize: "0.9rem", color: "#a06810" }}>
            🙏 願一切眾生離苦得樂 · 阿彌陀佛
          </p>
        </div>
      </main>
...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <section style={{ marginBottom: "1.75rem" }}>
      <h2 style={{
        fontFamily: "'Noto Serif TC','Noto Serif SC',serif", fontSize: "1.15rem", fontWeight: 600,
