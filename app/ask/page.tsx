      ...
      <main style={{ maxWidth: "760px", margin: "0 auto", padding: "1rem 1rem 2rem" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "1rem" }}>
          ...
          <h1 style={{
            ...
            fontSize: "1.5rem", fontWeight: 700, color: "#2c1810", marginBottom: "0.3rem",
          }}>
            問佛
          </h1>
          <p style={{
            fontFamily: "'Noto Sans TC','Noto Sans SC',sans-serif",
            fontSize: "0.9rem", color: "#8a5a2f", lineHeight: 1.6,
          }}>
        ...
        <div style={{
          ...
          <p style={{
            fontFamily: "'Noto Sans TC','Noto Sans SC',sans-serif",
            fontSize: "0.9rem", color: "#7a4c10", lineHeight: 1.7, margin: 0,
          }}>
