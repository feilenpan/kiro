...
export default function ChatInterface() {
  ...
  const [isRestoredHistory, setIsRestoredHistory] = useState(false); // 是否从历史恢复
  const [resumeDate,       setResumeDate]       = useState<string>("");  // 上次对话时间
  ...
  // 有历史恢复时，自动滚到最底部（让用户看到最新一条，而不是顶部旧记录）
  useEffect(() => {
