      ...
      <header style={{
        ...
        <div style={{
          ...
          <nav style={{ display: "flex", gap: "0.25rem", alignItems: "center" }} className="hidden-mobile">
            {navItems.map((item) => (
              <Link key={item.href} href={item.href} style={{
                ...
                color: "#5c3d2e", textDecoration: "none", transition: "background 0.2s",
              }}
            ...
            {/* 繁簡切換 */}
            <button onClick={toggle} title={variant === "SC" ? "切換到繁體" : "切換到簡體"} style={{
          ...
          <div className="show-mobile" style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
            <button onClick={toggle} style={{
              ...
              border: "1px solid rgba(201, 138, 22, 0.3)", background: "rgba(249, 237, 204, 0.6)",
              color: "#7a4c10", cursor: "pointer", fontSize: "0.8rem", fontFamily: "var(--font-sans)",
            }}>
              {variant === "SC" ? "繁" : "简"}
            </button>
        ...
        {menuOpen && (
          <div style={{
            ...
            padding: "0.75rem 1.25rem", background: "rgba(245, 240, 232, 0.98)",
          }}>
            {navItems.map((item) => (
              <Link key={item.href} href={item.href} onClick={() => setMenuOpen(false)} style={{
                ...
                color: "#2c1810", textDecoration: "none", marginBottom: "0.25rem",
              }}>
